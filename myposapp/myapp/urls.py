...
urlpatterns = [
    ...
    path('home-employee/', views.home_employee, name='home_employee'),
    path('order-employee/', views.Order1_staff, name='order_employee'),
    path('history-employee/', views.History_Order_staff, name='History_Order_employee'),
    path('member-employee/', views.Member1_staff, name='member_employee'),
    path('edit_member-employee/<int:member_id>/', views.edit_member_staff, name='edit_member_employee'),
    path('manage_ingredients-employee/', views.manage_ingredients_staff, name='manage_ingredients_employee'),
    path('edit_ingredient-employee/<int:ingredient_id>/', views.edit_ingredient_staff, name='edit_ingredient_employee'),
    path('add_ingredient-employee/', views.add_ingredient_staff, name='add_ingredient_employee'),
    path('paynow-employee/<int:order_id>/', views.PayNow_staff, name='paynow_employee'),
    path('payment-employee/<int:order_id>/', views.PayMent_staff, name='payment_employee'),
